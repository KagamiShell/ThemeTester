...
// *********************************************************************//
  CoInternetExplorer = class
    ...
    class function CreateRemote(const ComputerName: string): IWebBrowser2;
  end;
...
// *********************************************************************//
  CoShellWindows = class
    ...
    class function CreateRemote(const ComputerName: string): IShellWindows;
  end;
...
// *********************************************************************//
  CoShellUIHelper = class
    ...
    class function CreateRemote(const ComputerName: string): IShellUIHelper;
  end;
...
// *********************************************************************//
  CoShellNameSpace = class
    ...
    class function CreateRemote(const ComputerName: string): IShellNameSpace;
  end;
...
// *********************************************************************//
  CoCScriptErrorList = class
    ...
    class function CreateRemote(const ComputerName: string): IScriptErrorList;
  end;
...
// *********************************************************************//
  CoSearchAssistantOC = class
    ...
    class function CreateRemote(const ComputerName: string): ISearchAssistantOC3;
  end;
...
class function CoInternetExplorer.CreateRemote(const ComputerName: string): IWebBrowser2;
begin
  Result := CreateRemoteComObject(ComputerName, CLASS_InternetExplorer) as IWebBrowser2;
end;
...
class function CoShellBrowserWindow.CreateRemote(const ComputerName: string): IWebBrowser2;
begin
  Result := CreateRemoteComObject(ComputerName, CLASS_ShellBrowserWindow) as IWebBrowser2;
end;
...
class function CoShellWindows.CreateRemote(const ComputerName: string): IShellWindows;
begin
  Result := CreateRemoteComObject(ComputerName, CLASS_ShellWindows) as IShellWindows;
end;
...
class function CoShellUIHelper.CreateRemote(const ComputerName: string): IShellUIHelper;
begin
  Result := CreateRemoteComObject(ComputerName, CLASS_ShellUIHelper) as IShellUIHelper;
end;
...
class function CoShellNameSpace.CreateRemote(const ComputerName: string): IShellNameSpace;
begin
  Result := CreateRemoteComObject(ComputerName, CLASS_ShellNameSpace) as IShellNameSpace;
end;
...
class function CoCScriptErrorList.CreateRemote(const ComputerName: string): IScriptErrorList;
begin
  Result := CreateRemoteComObject(ComputerName, CLASS_CScriptErrorList) as IScriptErrorList;
end;
...
class function CoSearchAssistantOC.CreateRemote(const ComputerName: string): ISearchAssistantOC3;
begin
  Result := CreateRemoteComObject(ComputerName, CLASS_SearchAssistantOC) as ISearchAssistantOC3;
end;
